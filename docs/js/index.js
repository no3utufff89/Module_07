...
;// CONCATENATED MODULE: ./src/js/common/dataActions.js

const URL = 'https://pastoral-suave-minnow.glitch.me/api/';
const request = async props => {
  try {
    const response = await lib_axios.get(`${URL}${props.postfix}`);
    if (response) {
      const {
        data
      } = response;
...
;// CONCATENATED MODULE: ./src/js/cartActions/cartActions.js
const submitCart = () => {};
const calcResult = resultArr => {
...
const setStorage = (cart, newId, cartAddBtn) => {
...
;// CONCATENATED MODULE: ./src/js/modules/builder.js
...
const createSection = (data, props) => {
...
const createProductDetailedCard = data => {
  ...
  const container = el('.container', el('.card-header', el('h1.card__title', {
  ...
  const descriptionContainer = el('.description-container', el('.description', el('h2.description__title', {
...
const createBreadCrumbs = props => {
  ...
  const breadCrumbsItem = propsArr.map(item => {
    ...
    if (item.href) {
      const breadCrumbsItem = el('li.bread-crumbs__item', el('a.bread-crumbs__link', {
...
;// CONCATENATED MODULE: ./src/js/common/renderMenu.js
...
;// CONCATENATED MODULE: ./src/js/common/renderCards.js


const renderProfitProducts = () => {
  request({
...
const renderCurrentProduct = () => {
  ...
  request({
    ...
    const {
      cardWrapper,
      cardElements
    } = createProductDetailedCard(data);
...
;// CONCATENATED MODULE: ./src/js/cartActions/createCartProducts.js

const createCartProducts = item => {
...
;// CONCATENATED MODULE: ./src/js/cartActions/renderShoppingCart.js
...
const renderShoppingCart = async () => {
  ...
  Promise.all(cartStorageData.map(id => {
    return request({
      postfix: `goods/${id}`
    });
  })).then(arr => {
...
//
//         })
;// CONCATENATED MODULE: ./src/js/common/mountComponents.js
